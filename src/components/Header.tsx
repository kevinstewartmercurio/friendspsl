    ...
    return (
        <>
            ...
            <div className="w-full mb-8 px-6 md:px-12 flex flex-row">
                ...
                {/* popup buttons and theme toggle */}
                <div className="text-primary-text w-1/12 md:w-1/4 flex flex-row justify-end items-center">
                    <button className="border-transparent border-[1.5px] px-0.5 md:py-1.5 hidden lg:block hover:border-b-primary-text" onClick={(e) => {
                        e.preventDefault()
                        props.handlePopup("How it Works")
                    }}>
                        How it Works
                    </button>
                    <button className="border-transparent border-[1.5px] ml-10 px-0.5 md:py-1.5 hidden lg:block hover:border-b-primary-text" onClick={(e) => {
                        e.preventDefault()
