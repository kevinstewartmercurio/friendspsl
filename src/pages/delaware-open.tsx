...
//                 body: JSON.stringify({league: "delaware_open"})
//             })
...
//             method: "POST",
//             headers: {"Content-Type": "application/json"},
//             body: JSON.stringify({league: "delaware_open", playersLst: playersLst})
//         })
//             .then((res) => {
//                 if (res.ok) {
//                     return res.json()
...
//                 </div>
//                 <div>
//                     <InputNames league="2023 Delaware Open" handleSubmit={handleSubmit} scheduleGenerated={scheduleGenerated} readyToGenerate={readyToGenerate} errorType={errorType} />
//                 </div>
//                 <div>
